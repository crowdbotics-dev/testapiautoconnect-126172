...
## Project Structure
    ...
    ├── testapiautoconnect_126172  # Django project configurations
...
1. Clone this repo and `cd testapiautoconnect_126172`
...
2. Clone this repo and `cd testapiautoconnect_126172`
